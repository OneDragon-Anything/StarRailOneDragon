...
- `docs/game/currency_war/research/04_survival_budget.md` §7 hp 进决策授权对账表：登记裁定 6 行（授权日期 2026-09-12/形态 = 结算屏现成读数含 B/P 进遭遇决策/v1 不消费辖域/敌方通道退路）← E-4
