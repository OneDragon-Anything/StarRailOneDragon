...
- **行号**:
  - IMPL_DESIGN.md L584(R192 修注:「……12 类零截断分类……的逐类截断判以**契约 v2 提案**(`redesign/CONTRACT_V2_PROPOSAL.md`,**呈报件**)为准——**v2 定稿前批1 不得照抄本现表落码**……上行代码注释『判=契约 §3 初始枚举』随 v2 定稿改读『判=契约 §3(v2)备战线域』」);
