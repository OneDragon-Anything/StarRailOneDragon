...
class OneDragonContext(ContextEventBus, OneDragonEnvContext):
    ...
    def application_plugin_dirs(self) -> list[tuple[Path, PluginSource]]:
        ...
        例如：如果子类在 sr_od/context/sr_context.py，则返回：
        - (sr_od/application, BUILTIN)
        ...
        # 例如：sr_od/context/sr_context.py -> sr_od/application
    ...
    def _on_key_press(self, key: str):
        ...
        if key == self.key_start_running:
            ...
            self.run_context.stop_running(reason='gui:hotkey')
