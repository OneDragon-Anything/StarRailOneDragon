...
| [0116](0116-read-star-thresh-back6-edge.md) | read_star TM thresh 0.50→0.45 解后排-6 边槽第2星漏(迭代0114;whack-a-mole 根治待多模板) | accepted | 2026-08-13 | 各槽覆盖发现后排-6 椒丘2星读1;第2星非形状拒是TM val~0.45-0.50被thresh滤(模板取自备战栏,后排透视星更小匹配偏弱);降thresh到0.45(立绘库0/71+全fixture无新FP+后排-6读回2);每降一档解一槽是治标,根治待多模板per排(各排透视星独立模板) |
