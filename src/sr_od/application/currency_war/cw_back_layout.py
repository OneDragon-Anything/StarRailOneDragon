...
#: 全档闭环(r84,6-11;12 补 2026-08-23):格点模型 = 固定坐标格点(间距 142)上**交替右左扩窗**(从 6 槽
#: [606..1316] 起:7=右+1458/8=左+464/9=右+1600/10=左+322/11=右+1742/12=左+180 —— 七档窗口
#: 全部与格点吻合,7 槽右+1 由「464 处无暗框无占用 + 1458 附近空槽」双证据裁定;
#: 12 档=格点外推(交替序左扩,起 109;宝钻×7 局钩子触发两次实采 cap=12 形态,
#: 局74 双帧 VLM 8 槽读数与展开假说的分歧记录在 insights——12 坐标按格点模型
#: 落档,遇实拍机会校正)。
