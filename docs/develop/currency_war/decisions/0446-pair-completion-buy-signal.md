...
- 设计单一源:`.debug/temp/currency_war/w476_pair_signal/DESIGN.md`;A/B 判据=`.debug/temp/currency_war/w482_merged_ab/PRE_REGISTRATION.md`(判据未改);判定报告=`w482_merged_ab/REPORT.md`
