...
# #145「优先留着吃利息,前期掉点血没事」);hp<ALL_IN_HP_FLOOR→无条件花光(#62「快要死了就ALL IN」;
# #153「卖血不低于40」安全线)。「来牌顺」= 商店有可买战力件(shop_supply,无牌破息也无处花)。
ALL_IN_HP_FLOOR: int = 40             # 血量安全线(攻略 #153「卖血不低于40」;低于此 → ALL IN 成型)
