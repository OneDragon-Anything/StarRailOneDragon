...
- 俗称定位(电视机/红绿灯/琥珀王/死龙/酒杯怪)✅ 已全清(2026-08-17 用户核对):电视机=造梦互动娱乐/死龙=灰手生命科技/酒杯怪=造梦兄弟影业/琥珀王=铁盾安保集团,入 `BOSS_NICKNAMES`;红绿灯=小怪非 boss(忽略),`BOSS_MECHANIC_NICKS` 仅剩非 boss 词缀类。同日 **bosses.md 20/20 全量重采**(图鉴全解锁,新增 不死者联盟/绘师家族产业;截断全补齐),`BOSS_MECHANICS` tag 随之校准。
