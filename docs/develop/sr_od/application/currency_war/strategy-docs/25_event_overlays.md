...
> 画面族 = 节点 overlay 单选画面:货币战争-投资环境 / 货币战争-投资策略 / 货币战争-补给 / 货币战争-遭遇节点 / 货币战争-盛会之星 / 选择伙伴 / 命运卜者强化(cw_fortune_picker)/ 银狼升星(cw_yinlang_star_up)/ 祈愿试炼 / 星徽秘典四选一 / 专家邀请函 / 武装箱弹窗(原选择装备 cw_equip_pick 随该屏误判退役删除,2026-09-22);**能力面** = [../screens/README.md](../screens/README.md) §5.2/§5.5。本篇 = 该画面族的**策略面**。
