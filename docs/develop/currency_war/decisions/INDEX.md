...
| [0529-invest-strategy-entry-reprobe.md](0529-invest-strategy-entry-reprobe.md) | ADR-0529: 投资策略屏入口锚动画帧复探——单探测 round_fail 退役(20/21 局同型失败治本;首探 miss→短窗新截图复探,超窗仍 miss 才 fail),与 cw_loop N5 分发复探同族 | 已实施 |
