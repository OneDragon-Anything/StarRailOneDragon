...
| 系统设计 as-built(为什么有 v2/架构/决策链/模块地图/边界)+ 设计 why | `docs/develop/sr_od/application/currency_war/strategy-docs/README.md`(分篇入口)+ `decisions/`(ADR;redesign.md 已砍除归档,ADR-0365) |
| 决策 why(一决策一文件) | `docs/develop/sr_od/application/currency_war/decisions/`(INDEX + ADR-NNNN) |
