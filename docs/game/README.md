...
## 玩法知识分层:guides / research / 代码注册表

一个玩法的游戏知识按「谁写的、是否经我们核实」分三处(与 AGENTS.md「文档归位」条配合,本节为细则):

- **`docs/game/<玩法>/guides/`**:外部攻略原始转录,别人写的、按抓取时的游戏版本冻结(文件名带版本号);不改写、不更新,新版本出新文件。
- **`docs/game/<玩法>/research/`**:我们提炼或核实过的知识(社区帖统计提炼、机制核实、用户口述),**活文档**,随游戏版本原地更新;每篇标游戏版本。
