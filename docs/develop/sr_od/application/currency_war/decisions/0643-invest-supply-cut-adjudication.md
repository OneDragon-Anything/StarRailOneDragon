...
- 关联:ADR-0641(删除波 1——invest_cards 写入端删除 = 本件断供事实的执行批;
  ...
  payload 域)」指认本件定谳)、`docs/develop/sr_od/application/currency_war/game_state/r5-migration-plan.md`
  (§2 W7 行「候裁 2 定谳=删除前定谳硬门」/§5 风险 10/候裁清单第 2 条 = 定谳
  对象)、`docs/develop/sr_od/application/currency_war/game_state/retirement.md`(§2 invest_cards
