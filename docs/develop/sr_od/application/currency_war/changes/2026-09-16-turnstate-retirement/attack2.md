...
> 被审版本锚：commit `e69b4eda4`（20:43:55，"对抗 r2 报告入库…+二轮修订"）——r3 读取发生在该入库之后， design/landing/README 工作区 mtime 20:43:14–20:43:42 与本节全部落点引文一致，读取后至今零变更（git status 仅本报告文件有追加）。澄清：r2 轮读的是第一修订版（1ad2fcbb5，20:29）并据其产出 R2-1…R2-9；本节即针对修复该 9 项的第二修订版。
