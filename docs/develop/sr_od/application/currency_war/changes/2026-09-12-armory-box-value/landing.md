...
**完成判据**：
- design.md §2.6 行为变化表逐行锁全绿：R1 = 行 2b/4b/5/6/9 标准帧回归（含锚定一致性等价帧）；变化行（1/2/3/4a/4c/7a/7b/7c/8a/8b/8c/10）各自锚点锁（新文件 B 组，锁名清单进交付报告）
