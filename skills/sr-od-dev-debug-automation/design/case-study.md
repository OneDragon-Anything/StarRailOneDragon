...
> 以下完整排查历程来自 OneDragon 系列上游项目,作为 SKILL.md 4 节判据的**来源论据**保留。具体函数名 / 坐标 / 版本号是那次案例的偶然细节,**记这不进 SKILL.md**(`sr-od-dev-skill-guide` 硬规范 4:design/ 允许具体例子作决策论据,SKILL.md 只写方法论)。星铁侧待补本游戏真实案例。
