...
| P1 档位推进目标函数(**已删**) | `decision_v2/tier_push` | 旧方案存量目标型杠杆(伞 `p1_tier_push_enabled`+三子旗标默认关)——判据挂账未跑即悬置,经清查零新方案引用,已随清退批(dd-009)按开关生命周期第 4 态整批删除(模块/评分补项/散装门/预算承诺臂/刷新超几何项,registry 位置留墓碑注释);A/B 协议与负结果语义见 ADR-0494 与 prereg/w803 归档 | [0494](../decisions/0494-p1-tier-push-objective.md)+[dd-009](../decisions/dd-009-legacy-mechanism-eviction.md) |
