# Create SR OD Daemon Startup Shortcut
#
# This script creates a shortcut in the Windows Startup folder
# to automatically start SR OD Daemon when user logs in.
...
$ShortcutPath = Join-Path $StartupFolder "SR OD Daemon.lnk"

Write-Host "============================================================"  -ForegroundColor Cyan
Write-Host "SR OD Daemon - Startup Shortcut Creator" -ForegroundColor Cyan
Write-Host "============================================================"  -ForegroundColor Cyan
Write-Host ""
...
Write-Host ""
Write-Host "SR OD Daemon will now automatically start when you log in." -ForegroundColor Green
Write-Host ""
