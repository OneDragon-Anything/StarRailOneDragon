...
- ``CHARACTERS``:全量注册表(V4.4 74 名),**角色规范名单一真相源**。
...
CHARACTERS: dict[str, Character] = {c.name: c for c in [
    ...
    _ch("貊泽", 1, "back", "输出、辅助", "狼狩", "追击、减益", source="6530"),
    ...
    _ch("佩拉", 2, "back", "辅助、输出", "贝洛伯格", "", source="6133"),
    # —— 3 费 ——
    ...
    _ch("布洛妮娅", 5, "front", "辅助、输出", "贝洛伯格", "燃血", independent="大守护者", source="6189"),
