...
>
> 输入正本不变:`docs/develop/currency_war/game_state/retirement.md`(13 流处置表/11 消费面清单——
> 其逐流处置与消费面清册继续有效;影子期/M1-M5 排期/前置六条按本裁定重构)+
> `docs/develop/currency_war/decisions/0630-unified-state-journal.md`(含修订节;其决策 6「影子双写」
