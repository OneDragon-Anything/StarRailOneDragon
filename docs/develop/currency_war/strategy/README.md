...
| 状态机+LineStrategy(策略v2) | `cw_phase_machine`(时序装置转移纯函数,七性质穷举锁定)+`strategies/line_strategy`(继承 Default 只覆盖 4 策略性钩子:锁线/桥线/四象限/应急;P1 r5+ 决战窗 = 成型检查点→boss_breaker 集中买+配方围栏,ADR-0221/0225) | [redesign](../redesign.md) Phase A 决策循环 | [redesign](../redesign.md) · [07](07_plugin.md) |
