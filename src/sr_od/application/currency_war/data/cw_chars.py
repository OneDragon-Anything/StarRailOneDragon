...
CHARACTERS: dict[str, Character] = {c.name: c for c in [
    ...
    _ch("银狼LV.999", 3, "front", "输出", "星核猎手", "欢愉", independent="头号玩家", source="7466"),  # ⚠️ 3/4/5 费三档(升星升费):开局商店仅刷 3 费档,2 星升费后商店才出现高费档(用户口述 2026-08-28);cost=起始费,多档建模待策略层需要时扩(广场 id 15061/15062/15063,2026-08-15)
    # —— 4 费 ——
