...
# ②类专属信号注册表(family → 专属羁绊名;comp_definitions_v2 各套「核心/副档」栏):
# - 万敌燃血:夜之半神 2(96% 必配,主档);
# - DOT卡芙卡:持续伤害(开局即战力,前期=终局同体一路加深);
# - 姬子列车:列车同行(四人 100% 固定);
# - 黄泉减益:减益(4-6 档主体,到前 DOT 班底共享牌桌);
# - 欢愉族:欢愉(绯英/银狼两档共用主体);
# - 圣杯双C:命运圣杯(2 档开任务=燃料线入口);
# - 大黑塔群攻:银河学者(星级总量成长);
# 希儿量子/白厄反甲**无②信号**:量子/贝是放大器不是独立伤害源(点2 卡4 语义),
# 白厄=独立羁绊绑死单卡(只走③)。
