...
- 关联:ADR-0634(直迁裁定——旧流=删除代码非停写,本件承接该义务的执行批)、
  `docs/develop/sr_od/application/currency_war/game_state/r5-migration-plan.md`(R5 迁移规划,
  波次排期正本:删除波 1 对应其 W7/P7 删除面的先行段)、
  `docs/develop/sr_od/application/currency_war/game_state/retirement.md`(§2 逐流处置表=删除对象
