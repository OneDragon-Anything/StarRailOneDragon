...
> - [T-37 登记][已入册] 两条款正本化已完成(commit 9c8e9016b:op-layer.md §1.1 :35「选择坐标观察上报」/§1.2 :48「每个动作 op 单独一个文件」);action_ops.md §1 同落未兑现,归 T-37;本稿引用一律挂条款名锚,行号(:35/:48/:37)为辅注。
