...
> - 原始路径:`.debug/temp/currency_war/T-217-流程hook设计v1.md`
> - 找回日期:2026-09-11
> - 对应账本任务:T-8 同域(旧账 T-217 流程 hook 观测点设计批;其内容已并入正本 v10 §12 流程转点观测锚章)
> - 地位注记:正本引用参照件——正本修订记录声明「v10 对照说明见本件(R2)」,本件为该对照说明唯一载体;本体标题虽为交付报告,按正本活引用规则找回
...
> `docs/develop/currency_war/design/统一观察架构-画面op基类设计.md`
...
3. **准确性判据**:指标 1 闭合公式重构(发现 2)——立「尝试口径」
   ...
   **五条**(发现 6:锁④拆写向/读向两条——决策代码禁读锚行的 grep
   守卫沿 ADR-0577 先例方向,effect_ref 恒空补非空=红结构锁)。
