...
class DecisionTrace:
    ...
    # 血预算停手·终止分支决策位(写入侧单一源 =
    # sim/checks/segments.terminal_release_bit 的实机遥测透传位;
    # 设计 W659 v2 §5.1 R4;ADR-0469。写入面已随 v2 退役链退役,
    # 字段保留为 schema 缺省——None=无 match 注册/未写)。None=无 match
    # 注册(离线/测试)。
