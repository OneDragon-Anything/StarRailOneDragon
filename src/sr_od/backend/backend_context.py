...
from sr_od.backend.schemas import AnalyzeScreenResult, OcrText, WindowStatus
...
class SrBackendContext:
    ...
    def enter_game(self) -> str:
        ...
        通过 ``OpenAndEnterGame`` 操作打开并进入星穹铁道游戏。这是一个长阻塞流程，
        ...
        Raises:
            BackendNotReadyError: ``SrContext`` 未就绪，或运行上下文启动失败时抛出。
        """
        self._ensure_ready()
