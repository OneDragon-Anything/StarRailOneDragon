...
- 外循环分支 0a3:**双 id_mark 门**——「货币战争-命运卜者强化.标识-命运卜者」∧「货币战争-命运卜者强化.标识-请选择强化效果」同帧命中;dispatch 带 on_fail_retry(失败消费重试池)。序位先于备战双锚,单一源 = [../flow/outer_loop.md](../flow/outer_loop.md) §2.2。
