...
async def handle_health(backend: SrBackendContext, _request: Request | None = None) -> Response:
...
async def handle_game_applications(backend: SrBackendContext, _request: Request | None = None) -> Response:
...
async def handle_game_run_one_dragon(backend: SrBackendContext, request: Request | None = None) -> Response:
...
async def handle_game_operations_describe(
    backend: SrBackendContext, request: Request | None = None,
) -> Response:
