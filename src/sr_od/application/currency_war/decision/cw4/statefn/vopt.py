...
def p_miss(level: int, cost: int, j: int, taken_c: int,
    ...
    from sr_od.application.currency_war.decision.cw4.statefn.odds import slot_q
...
def a7_lower_bound(level: int, cost: int, refresh_cost: int, j: int = 0,
    ...
    from sr_od.application.currency_war.decision.cw4.statefn.odds import p_shop
