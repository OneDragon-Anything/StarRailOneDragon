...
| 货币战争 | [currency_war_lobby.md](currency_war_lobby.md) | `currency_war`,auto-chess 肉鸽,建档进行中(2026-08)。子屏 doc:大厅·模式选择·难度确认·简报·[BOSS简报](currency_war_boss_briefing.md)(强敌来袭横幅,徽记模板锚)·投资环境·备战·商店·[遭遇节点](currency_war_encounter.md)·战斗·补给·投资策略·[未达上限警告](currency_war_deploy_warning.md)·[结算](currency_war_settlement.md)·[挑战失败](currency_war_challenge_failed.md)·[选择伙伴](currency_war_choose_partner.md)·[盛会之星](currency_war_megastar.md)(羁绊触发的选巨星 overlay);**攻略面板**([列表](currency_war_guide_list.md)·[详情](currency_war_guide_detail.md)·[图例](currency_war_guide_legend.md)·[攻略码输入](currency_war_guide_code_input.md)·[保存阵容](currency_war_guide_save_modal.md)·[装备追踪](currency_war_guide_equip_track.md)·[阵容编辑](currency_war_guide_editor.md),2026-08-15 建档);备战子态屏:[角色详情](currency_war_char_detail.md)(点角色)+ 开商店(无独立 doc);独立装备详情(备战右侧装备,待建档);**情报画面族**(2026-08-26):[位面详情](货币战争-位面详情.md)(备战点节点图标直开,三位面卡+节点详情条+常驻词缀横条)+[敌人信息浮层](货币战争-敌人信息浮层.md)(备战点难度框开,敌方波次+详情卡)——中途接管局补采词缀/难度/环境的入口;**数据银行族**(2026-08-26):[数据银行](货币战争-数据银行.md)(五图鉴入口卡主页)+[竞争对手图鉴列表](货币战争-竞争对手图鉴列表.md)(底部 boss 页签行)+[竞争对手图鉴详情](货币战争-竞争对手图鉴详情.md)(boss 立绘+精英/普通敌人+技能两阶段;顶部头像导航条=boss_avatar 模板库来源)——canonical 数据采集入口,bot 不自动化 |
