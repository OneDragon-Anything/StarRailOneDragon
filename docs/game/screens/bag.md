...
- **分类 tab ×10**(位置待实拍确认:两次 视觉大模型 对主分类 tab 位置描述矛盾——一次"左侧竖排"、一次"顶部横排",可能主分类 tab 与子分类标签如「角色经验材料/行迹材料」混淆):养成材料(当前选中)/ 消耗品 / 光锥 / 遗器 / 任务 / 其他材料 / 宠物 / 贵重 / 遗器分解 / 分解过滤。切 tab 实拍精确定位 + 各分类态归档待补。
...
- **视觉大模型 待补**:各分类 tab 实拍、销毁弹窗 视觉大模型。
