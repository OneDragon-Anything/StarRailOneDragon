...
- **状态（2026-09-12）**：
  ...
  - 商店 `mm_ol_50`：已入库——官方 glyph + **合成黑菱形底座**（官方图无菱形，游戏渲染时叠加；实裁量得菱形跨径 34px/色 7,9,11，glyph 高 31px 上移 2px），旧图商店点掩码 conf 0.739（实裁 mm_sp_03=0.816）
  - 特殊商店 `mm_ol_49`：合成后 0.649 未达 0.7 门（¥袋 glyph 细节差异），文件留 .debug 不入库，新图特殊商店暂用实裁兜底
