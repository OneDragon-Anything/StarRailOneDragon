...
set "TARGET_DIR=%DIST_DIR%\StarRailOneDragon"
...
powershell -Command "Compress-Archive -Path '%DIST_DIR%\OneDragon-Launcher.exe' -DestinationPath '%DIST_DIR%\StarRailOneDragon-Launcher.zip' -Force"
powershell -Command "Compress-Archive -Path '%DIST_DIR%\OneDragon-RuntimeLauncher\OneDragon-RuntimeLauncher.exe','%DIST_DIR%\OneDragon-RuntimeLauncher\.runtime' -DestinationPath '%DIST_DIR%\StarRailOneDragon-RuntimeLauncher.zip' -Force"
